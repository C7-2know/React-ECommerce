...
const NavButton=({title, customFunc, icon, color, dotColor})=>(
  <TooltipComponent className='' position='BottomCenter' content={title}>
      ...
      <div className='flex'>
        ...
        >
          ...
          onClick={()=>handleClick('userProfile')}>
            ...
            />
            <p>
              <span className='text-gray-400 text-l4'>Hi, </span>{" "}
              <span className='text-gray-400 font-bold ml-1 text-l4'>Michael</span>
            </p>
            <MdKeyboardArrowDown 
